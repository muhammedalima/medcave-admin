...
import 'package:medcave/common/service/firebase_lab.dart';

class LabTestsTab extends StatelessWidget {
  final String searchQuery;
  final Function(String) logActivity;
  final FirebaseComponentService2 _firebaseService =
      FirebaseComponentService2();
                ...
                children: [
                  ...
                  TextField(
                      ...
                      decoration: const InputDecoration(
                          ...
                          border: OutlineInputBorder(),
                          hintText: 'E.g., Fasting for 8 hours'),
                      maxLines: 3),
                  const SizedBox(height: 16),
                  SwitchListTile(
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  await FirebaseComponentService2().addLabTest(
  ...
  void _showEditDialog(
    ...
    final prerequisitesController =
        TextEditingController(text: data['prerequisites']);
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  await _firebaseService.updateLabTest(
                    labTestId: docId,
                    name: nameController.text.trim(),
                    price: double.tryParse(priceController.text) ?? 0.0,
                    prerequisites: prerequisitesController.text.trim(),
                  ...
                  logActivity(
                      'Updated lab test: ${nameController.text.trim()}');
                  Navigator.pop(context);
                },
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              await _firebaseService.deleteLabTest(docId);
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: _firebaseService.getLabTestsStream(),
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          return const Center(child: CircularProgressIndicator());
        }
        if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
          return _buildEmptyState('No lab tests available',
              'Add a new lab test using the + button');
        }
        ...
        if (filteredDocs.isEmpty) {
          return _buildEmptyState(
              'No matching lab tests', 'Try a different search term');
        }
              ...
              child: Column(
                children: [
                  ListTile(
                    ...
                    title: Text(data['name'] ?? 'Unnamed Test',
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        ...
                        if (data['prerequisites'] != null &&
                            data['prerequisites'].toString().isNotEmpty)
